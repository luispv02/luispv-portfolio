...
export const ProjectCard = ({ github,imagen,pagina,titulo, descripcion}) => {
  return (
    <div className="project-card w-full h-64 relative shadow-xl/20 duration-500 cursor-pointer hover:-translate-y-3">
        <img 
            src={imagen}
            alt='img project'
        ...
        <div className="project-card-info z-3 pt-15 text-white opacity-0 translate-0 duration-600 transition-all absolute bottom-5 right-0 px-5 text-center hover:translate-y-1 hover:opacity-100">
